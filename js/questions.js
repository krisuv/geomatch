...
const Question9 = new Question(
    ...
    new Answer('romantic/classical',india, uae, czechia, indonesia, egypt, greece, mexico, israel),
...
const Question15 = new Question(
    ...
    '🥊',
    new Answer('ground fighting', japan, brazil, mexico, china, italy, russia, finland),
    new Answer('punching and kicking',canada, usa, poland, australia, germany, czechia, uk),
    new Answer('fight with equipment', india, indonesia, israel, egypt, uae, greece, uganda)
)
...
const Question20 = new Question(
    ...
    new Answer('melancholic', israel, mexico, egypt, czechia, greece, china, italy, germany, india),
